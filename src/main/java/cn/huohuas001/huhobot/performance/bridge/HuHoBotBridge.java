...
public final class HuHoBotBridge {
    ...
    public void connect() throws ReflectiveOperationException {
        ...
        Object registered;
        try {
            registered = Reflect.invoke(huHoBot, "registerBotCommand", commandKey, "huhobotperformance bridge", 0, pushMenu);
        } catch (NoSuchMethodException error) {
            registered = Reflect.invoke(huHoBot, "registerBotCommand", commandKey, "huhobotperformance bridge");
        }
